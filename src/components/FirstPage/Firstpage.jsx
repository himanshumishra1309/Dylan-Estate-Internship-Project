...
function Firstpage() {
  ...
  return (
    <div className='bg-blue-950 max-[1440px]:pb-96 overflow-y-hidden'>
    <div className='flex items-start flex-col justify-center ml-20 pb-20 pt-16 overflow-y-hidden max-[768px]:pt-3 max-[768px]:mb-10 '>
